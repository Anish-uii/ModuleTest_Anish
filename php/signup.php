...
<head>
  ...
  <title>Stocks.com - Sign Up</title> 
</head>

<body>
  <section class="center-container">
    <section class="container">
      <form action="../db/signupcheck.php" method='post' class="name-form" id='myForm'>
        ...
        <div class="input-wrapper">
          ...
          <input type="password" name="password" id="repassword" required placeholder="Confirm your Password">
        ...
        <span class='signup-link'>Already registered?
          <a href="../index.php">Login from here</a>.</span>
      </form>
    </section>
